...
(function(root) {
  ...
  if (typeof(exports) !== "undefined" && exports._) {
    ...
    try{
		...
		Bmob.localStorage = require('./storage.js').localStorage;
	}
  ...
  Bmob._getInstallationId = function() {
    ...
    if (!Bmob._installationId || Bmob._installationId === "") {
	  ...
	  window.LS.set(path, Bmob._installationId);
...
(function(root) {
  ...
  Bmob.User = Bmob.Object.extend("_User", /** @lends Bmob.User.prototype */ {
    ...
    logOut: function() {
	  ...
	  window.LS.remove(Bmob._getBmobPath(Bmob.User._CURRENT_USER_KEY));
    ...
    current: function() {
	  ...
	  var userData = window.LS.get(Bmob._getBmobPath(
